...
//		context.addProperty(PropertyRegistry.CONTEXT_AUTO_DELIMIT_KEYWORDS, "false");
        ...
        /** 实现Serializable接口及生成private static final long serialVersionUID = 1L; **/
...
//		commentGeneratorConfiguration.addProperty(PropertyRegistry.COMMENT_GENERATOR_ADD_REMARK_COMMENTS, "true");
        ...
        javaModelGeneratorConfiguration.addProperty(PropertyRegistry.ANY_ROOT_CLASS, ProjectConstant.BASE_ENTITY);
...
//			data.put("modelNameLowerCamel", tableNameConvertLowerCamel(tableName));
            ...
            data.put("CONTROLLER_PACKAGE", ProjectConstant.CONTROLLER_PACKAGE);
            data.put("MAPPER_PACKAGE", ProjectConstant.MAPPER_PACKAGE);
            data.put("MODEL_PACKAGE", ProjectConstant.MODEL_PACKAGE);
            data.put("SERVICE_PACKAGE", ProjectConstant.SERVICE_PACKAGE);
            data.put("SERVICE_IMPL_PACKAGE", ProjectConstant.SERVICE_IMPL_PACKAGE);
