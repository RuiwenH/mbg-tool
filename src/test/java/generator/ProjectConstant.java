...
public final class ProjectConstant {
    ...
    public static final String MODEL_PACKAGE = BASE_PACKAGE + ".model.entity";// 实体类所在包
    public static final String BASE_ENTITY = BASE_PACKAGE + ".core.BaseEntity"; // 实体类ROOT_CLASS
